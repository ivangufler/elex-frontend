<template>
  <div v-if="election">
    ...
    <p class="m-5 font-cfont mt-4 text-gray-500 text-sm">
      Die Wahl erfolgt anonym und es sind keine Rückschlüsse auf Ihre Person
      möglich
    </p>
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-500 font-cfont">
                    <span v-if="checkedOptions.length === 0"
                      >Sind Sie sich sicher weiß zu wählen?</span
                    >

                    <span v-if="checkedOptions.length === 1"
                      >Sie haben "{{ checkedOptions[0] }}" ausgewählt.<br />
